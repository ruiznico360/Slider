...
////                        @Override
////                        public void run() {
////                            Intent openMainActivity = new Intent(SystemOverlay.service.getApplicationContext(), Slider.class);
...
////                    new InternetHandler(Slider.this, frags.get(1));
////                } else if (position == 3) {
////                    pager.setCurrentItem(2, false);
////                    getNavigator().setSelected(3);
////                    startActivity(new Intent(Slider.this, SettingsActivity.class));
////                } else {
